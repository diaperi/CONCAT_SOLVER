...
//        String fftSpectrogramPath = "D:\\CONCAT\\CONCAT_SOLVER\\BACK\\SolverWeb\\src\\main\\resources\\static\\media\\fft_spectrogram_" + timeStamp + ".png";
//
//        // 기존 스펙트로그램 파일 삭제 (필요한 경우 삭제할 수 있지만, 타임스탬프 추가로 덮어쓰지 않음)
//        // deleteOldSpectrogramImage(fftSpectrogramPath);
//
//        // FFT 및 주파수 분석에 필요한 설정
//        int fftSize = 2048; // FFT 크기
