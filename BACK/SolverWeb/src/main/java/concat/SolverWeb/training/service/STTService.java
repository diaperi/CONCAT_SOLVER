...
//    private final String invokeUrl = "https://clovaspeech-gw.ncloud.com/external/v1/8531/872a525de28f00ce398d05183da7b7bae2862e2e93a6e3443d267acc65fe95f0"; // 실제 URL로 변경
//    private final String secret = "bd1572f14ef24de79c9c3c78a599f6d0"; // 실제 API 키로 변경
//    private final String wavFilePath = "D:\\CONCAT\\CONCAT_SOLVER\\BACK\\SolverWeb\\src\\main\\resources\\static\\media\\audio.wav";
//
...
// **************** 디코딩 ******************** //
//    public void decodeBase64ToImage(String base64Data, String outputPath) throws IOException {
//        // Base64 데이터의 접두사 제거 (예: "data:image/png;base64,")
...
//        }
//
//        logger.info("이미지가 저장되었습니다: {}", outputPath);
//    }
//
//    public void analyzeImage(String imagePath) throws IOException {
//        // 이미지 읽기
...
//                colorCount.put(rgb, colorCount.getOrDefault(rgb, 0) + 1); // 색상 카운트 증가
//            }
//        }
//
//        // 가장 많이 발생한 색상 찾기
//        int mostFrequentColor = colorCount.entrySet().stream()
//                .max(Map.Entry.comparingByValue())
//                .map(Map.Entry::getKey)
//                .orElse(0);
//
//        logger.info("가장 많이 발생한 색상: {}", Integer.toHexString(mostFrequentColor));
//    }
//
//    public void processAndAnalyzeBase64Image(String base64Data) {
//        String imagePath = "D:\\CONCAT\\CONCAT_SOLVER\\BACK\\SolverWeb\\src\\main\\resources\\static\\media\\decoded_image.png";
//        try {
//            decodeBase64ToImage(base64Data, imagePath);
