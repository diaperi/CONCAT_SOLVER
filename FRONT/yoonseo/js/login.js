...
//         } else {
//             window.location.href = '/user/register'; // 메인 페이지와 연결해야 함. 일단 임시로 register.html과 연결함.
//         }
//     });
// });
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('login_btn').addEventListener('click', function(event) {
        ...
        if (username === '' || password === '') {
            ...
            window.location.href = '/hyeeun/mainpage.html'; // 메인 페이지와 연결해야 함. 일단 임시로 register.html과 연결함.
        }
    });
});
