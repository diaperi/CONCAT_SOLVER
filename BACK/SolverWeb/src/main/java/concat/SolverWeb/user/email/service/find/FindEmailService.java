...
public class FindEmailService {
    ...
    public String createEmailText(UserDTO user, String tempPassword) {
        return "<div style='font-family: Arial, sans-serif; font-size: 15px; color: #333;'>"
                ...
                + "<p>감사합니다.</p><br>"
                + "<p style='font-size: 16px; font-weight: bold;'><b>아이디:</b> " + user.getUserId() + "</p>"
                + "<p style='font-size: 16px; font-weight: bold;'><b>임시 비밀번호:</b> <span style='color: #4461F2;'>" + tempPassword + "</span></p>"
